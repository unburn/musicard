...
canvas.GlobalFonts.registerFromPath(
  `build/structures/font/circularstd-black.otf`,
  "circular-std"
);
canvas.GlobalFonts.registerFromPath(
  `build/structures/font/notosans-jp-black.ttf`,
  "noto-sans-jp"
);
canvas.GlobalFonts.registerFromPath(
  `build/structures/font/notosans-black.ttf`,
  "noto-sans"
);
canvas.GlobalFonts.registerFromPath(
  `build/structures/font/notoemoji-bold.ttf`,
  "noto-emoji"
);
canvas.GlobalFonts.registerFromPath(
  `build/structures/font/notosans-kr-black.ttf`,
  "noto-sans-kr"
);
...
class MusicCard {
  constructor({
    ...
    theme = "classic",
    brightness = 0,
    thumbnail = "https://s6.imgcdn.dev/Opo4a.jpg",
    progress = 0,
    starttime = "0:00",
    endtime = "0:00",
  } = {}) {
   ...
   * @param {string} author - The autor of the song
   * @returns {this}
   */
  setAuthor(author) {
    this.author = author;
   ...
   * @param {"dynamic" | "classic"} theme - The theme of the card
   * @returns {this}
   */
  setTheme(theme) {
  ...
  /**
   * Sets the brightness of the the card
   * @param {number} brightness - Brightness of the card
   * @returns {this}
   */
  ...
  /**
   * Sets thumbnail for the card
   * @param {string} thumbnail - The thumbnail of the card
   * @returns {this}
   */
  ...
  /**
   * Sets the current progress to the card
  ...
  /**
   * Sets the start time of the song to the card
  ...
  setStartTime(startTime) {
    if (!isTimeFormat(startTime)) {
      throw new TypeError(
        `Expected a valid time type. Example: 0:11. ${startTime} is invalid.`
      );
    }
    this.starttime = startTime;
    return this;
  ...
  /**
   * Sets the end time of the song to the card
  ...
  setEndTime(endTime) {
    if (!isTimeFormat(endTime)) {
      throw new TypeError(
        `Expected a valid time type. Example: 0:11. ${endTime} is invalid.`
      );
    }
    this.endtime = endTime;
    return this;
  ...
  async build() {
    ...
    if (this.theme == "classic") {
      ...
      throw new Error(
        'Invalid theme parameter, must be "classic" or "dynamic"'
      );
    }
  }
}
